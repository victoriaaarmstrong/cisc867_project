...
def main():
  ...
  #checkpoint = torch.load("./checkpoints/checkpoint_first_epoch")
  #checkpoint = torch.load("./checkpoints/checkpoint_epoch_50")
  checkpoint = torch.load("./checkpoints/checkpoint_final_epoch")
  ...
  #train_data = torch.load('./dataloader/train_dataloader')
  test_data = torch.load('./dataloaders/test_dataloader')
  ...
  ## Iterate through the testing data and save the real and fake data
  ...
  ## Save images of the real batches
  ctr = 0
  ...
  ## Save images of the fake generated batches
  ctr = 0
